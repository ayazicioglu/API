...
public class C08_JSONObjectVerileriCagirma {
    ...
    public void jsonPath01(){
        ...
        System.out.println("Sehir Adi: "+kisiBilgisi.getJSONObject("address").get("city"));
        System.out.println("Posta kodu: "+kisiBilgisi.getJSONObject("address").get("postalCode"));
        System.out.println("Ceptel no: "+kisiBilgisi.
                                            getJSONArray("phoneNumbers").
                                            getJSONObject(0).
                                            get("number"));
        System.out.println("Telefon turu: "+kisiBilgisi.
                                             getJSONArray("phoneNumbers").
                                             getJSONObject(1).
                                             get("type"));
        System.out.println("Telefon turu: "+kisiBilgisi.
